    ...
    function (e, t, n) {
        ...
        ! function (e, t) {
            ...
            var n, r, i, o = e,
                ...
                k = function (e) {
                    ...
                    if ("object" != typeof e || null == e || "number" == typeof e.nodeType) t = e;
                        ...
                        for (t = [], n = 0, r = e.length; n < r; n++) w.call(e, n) && (t[n] = k(e[n]));
                    else {
                        t = {};
                ...
                ne = function (e, t) {
                    ...
                    if (0 === arguments.length ? o = x(P) : "string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function (t) {
                        ...
                        for (n = 0, r = o.length; n < r; n++)
                            if (e = o[n].replace(/^on/, ""), (a = P[e]) && a.length)
                                if (t)
                ...
                ae = function () {
                    ...
                    if (!Q()) return q.ready = !1, void Ke.emit({
                        type: "error",
                        name: "browser-unsupported"
                    });
                ...
                Te = function (e) {
                    ...
                    case "_mouseout":
                        ...
                        break;
                    case "_mousedown":
                        He(t, K.activeClass), !0 === K.bubbleEvents && o && Ce(S({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_mouseup":
                        qe(t, K.activeClass), !0 === K.bubbleEvents && o && Ce(S({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_click":
                        i = null, !0 === K.bubbleEvents && o && Ce(S({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_mousemove":
            ...
            var nt = function (e) {
                ...
                at = function (e) {
                    var t, n = this;
                    return ft.call(n, e) && ("object" == typeof e && e && "string" == typeof e.type && e.type && (e = S({}, e)), t = S({}, me(e), {
                        client: n
                    }), dt.call(n, t)), n
                },
                st = function (e) {
    ...
    function (e) {
        ...
        function l(e) {
            s({
                ...
                if (0 == e.errorcode && e.key) {
                    var t = n(),
                        r = A; - 1 != location.search.indexOf("type=pdf") && (r = resultUrlPdf), p("#language").val("AUTO"), window.location.href = [r, "?key=" + e.key, "&from=" + t.from, "&to=" + t.to, "&type=" + t.type].join("")
        ...
        t.init = function () {
            ...
            s({
                ...
                beforeSubmit: function (e, t, n) {}, uploadProgress: function (e, t, n, r) {
            ...
            e.fn.attr2 = function () {
                ...
                function c(n) {
                    ...
                    if (f.iframeTarget ? (x = (m = e(f.iframeTarget, S)).attr2("name")) ? h = x : m.attr2("name", h) : (m = e('<iframe name="' + h + '" src="' + f.iframeSrc + '" />', S)).css({
                        ...
                        status: 0,
                        statusText: "n/a",
                        getAllResponseHeaders: function () {}, getResponseHeader: function () {}, setRequestHeader: function () {}, abort: function (t) {
                ...
                } else t.success && (e.isArray(t.success) ? e.merge(w, t.success) : w.push(t.success)); if (t.success = function (e, n, r) {
                ...
                for (u = 0, m = c.length; u < m; u++)
                    ...
                    for (n && n.push(h), f = 0, g = p.length; f < g; f++) i.push({
                        name: d,
                        value: p[f]
                    });
        ...
        return function (e, t) {
            ...
            function v(e, t) {
                t.src ? R.ajax({
                    ...
                    async: !1,
                    dataType: "script"
                }) : R.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Se, "/*$0*/")), t.parentNode && t.parentNode.removeChild(t)
            }
            ...
            function A(e) {
                if (!gt[e]) {
                    var t = O.body,
                        n = R("<" + e + ">").appendTo(t),
                        r = n.css("display");
                    n.remove(), "none" !== r && "" !== r || (dt || ((dt = O.createElement("iframe")).frameBorder = dt.width = dt.height = 0), t.appendChild(dt), pt && dt.createElement || ((pt = (dt.contentWindow || dt.contentDocument).document).write(("CSS1Compat" === O.compatMode ? "<!doctype html>" : "") + "<html><body>"), pt.close()), n = pt.createElement(e), pt.body.appendChild(n), r = R.css(n, "display"), t.removeChild(dt)), gt[e] = r
                }
                return gt[e]
            }
                ...
                R = function () {
                    ...
                    return s.fn = s.prototype = {
                        ...
                        var e, n, r, i, o, a, l = arguments[0] || {},
                            ...
                            u = arguments.length,
                            f = !1;
                        for ("boolean" == typeof l && (f = l, l = arguments[1] || {}, c = 2), "object" == typeof l || s.isFunction(l) || (l = {}), u === c && (l = this, --c); c < u; c++)
            ...
            R.fn.extend({
                attr: function (e, t) {
                    ...
                    if (e && "string" == typeof e)
                        for (t = e.split($), n = 0, r = this.length; n < r; n++)
                    ...
                    if (e && "string" == typeof e || e === t)
                        for (n = (e || "").split($), r = 0, i = this.length; r < i; r++)
                    ...
                    return R.isFunction(e) ? this.each(function (n) {
                        ...
                        if ("string" === n)
                            for (var i, o = 0, a = R(this), s = t, l = e.split($); i = l[o++];) a[(s = r ? s : !a.hasClass(i)) ? "addClass" : "removeClass"](i);
                ...
                attr: function (e, n, r, i) {
                    ...
                    var n, r, i, o, a = 0;
                    if (1 === e.nodeType)
                        for (o = (r = (t || "").split($)).length; a < o; a++) i = r[a].toLowerCase(), n = R.propFix[i] || i, R.attr(e, i, ""), e.removeAttribute(K ? i : n), Z.test(i) && n in e && (e[n] = !1)
                }, attrHooks: {
                    type: {
                        set: function (e, t) {
                    ...
                    add: function (e, n, r, i, o) {
                        ...
                        if (m && (u = m.events)) {
                            for (t = oe(t || "").split(" "), i = 0; i < t.length; i++) {
                                ...
                                if (f = R.event.special[a] || {}, a = (r ? f.delegateType : f.bindType) || a, p = u[a] || [], l = p.length, s = s ? new RegExp("(^|\\.)" + s.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, n || s || r || f.remove)
                                    for (c = 0; c < p.length; c++) h = p[c], n && n.guid !== h.guid || s && !s.test(h.namespace) || (!r || r === h.selector || "**" === r && h.selector) && (p.splice(c--, 1), h.selector && p.delegateCount--, f.remove && f.remove.call(e, h));
                                else p.length = 0;
                        ...
                        if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                            ...
                            if (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (g = (v = g.split(".")).shift(), v.sort()), i && !R.event.customEvent[g] || R.event.global[g])
                                if (n = "object" == typeof n ? n[R.expando] ? n : new R.Event(g, n) : new R.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = v.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = g.indexOf(":") < 0 ? "on" + g : "", !o && i || n.preventDefault(), i) {
                    ...
                    var d = function (e, t, n, i) {
                        ...
                        if (T.length > 1 && m.exec(e))
                            if (2 === T.length && h.relative[T[0]]) l = x(T[0] + T[1], t, i);
                                ...
                                for (l = h.relative[T[0]] ? [t] : d(T.shift(), t); T.length;) e = T.shift(), h.relative[e] && (e += T.shift()), l = x(e, l, i);
                        else if (!i && T.length > 1 && 9 === t.nodeType && !w && h.match.ID.test(T[0]) && !h.match.ID.test(T[T.length - 1]) && (t = (f = d.find(T.shift(), t, w)).expr ? d.filter(f.expr, f.set)[0] : f.set[0]), t)
                            for (l = (f = i ? {
                                expr: T.pop(),
                                set: v(i)
                            } : d.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t : t.parentNode, w)).expr ? d.filter(f.expr, f.set) : f.set, T.length > 0 ? c = v(l) : b = !1; T.length;) g = p = T.pop(), h.relative[p] ? g = T.pop() : p = "", null == g && (g = t), h.relative[p](c, g, w);
                        else c = T = []; if (c || (c = l), c || d.error(p || e), "[object Array]" === a.call(c))
                            if (b)
                                if (t && 1 === t.nodeType)
                                    for (y = 0; null != c[y]; y++) c[y] && (!0 === c[y] || 1 === c[y].nodeType && d.contains(t, c[y])) && n.push(l[y]);
                                else
            ...
            var pe = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
                ...
                Ee = u(O);
            ke.optgroup = ke.option, ke.tbody = ke.tfoot = ke.colgroup = ke.caption = ke.thead, ke.th = ke.td, R.support.htmlSerialize || (ke._default = [1, "div<div>", "</div>"]), R.fn.extend({
                text: function (e) {
            ...
            R.fn.css = function (e, n) {
                ...
                R.cssHooks[t] = {
                    get: function (e, n, r) {
                        var i;
                        if (n) return 0 !== e.offsetWidth ? y(e, t, r) : (R.swap(e, Ie, function () {
                            i = y(e, t, r)
                        }), i)
                    }, set: function (e, t) {
                    ...
                    function r(e, n, r, a) {
                        if (2 !== w) {
                            ...
                            if (e >= 200 && e < 300 || 304 === e)
                                if (d.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (R.lastModified[i] = b), (x = T.getResponseHeader("Etag")) && (R.etag[i] = x)), 304 === e) S = "notmodified", c = !0;
                                else try {
                                    f = C(d, k), S = "success", c = !0
                                } catch (e) {
                                    S = "parsererror", y = e
                                } else y = S, S && !e || (S = "error", e < 0 && (e = 0));
                            T.status = e, T.statusText = "" + (n || S), c ? m.resolveWith(p, [f, S, T]) : m.rejectWith(p, [T, S, y]), T.statusCode(v), v = t, u && h.trigger("ajax" + (c ? "Success" : "Error"), [T, d, c ? f : y]), g.fireWith(p, [T, S]), u && (h.trigger("ajaxComplete", [T, d]), --R.active || R.event.trigger("ajaxStop"))
                        }
                    }
                    "object" == typeof e && (n = e, e = t), n = n || {};
                    var i, o, a, s, l, c, u, f, d = R.ajaxSetup({}, n),
                        p = d.context || d,
            ...
            R.fn.extend({
                ...
                toggle: function (e, t, n) {
                    ...
                    function i() {
                        ...
                        var t, n, r, i, a, s, l, c, u, f = R.extend({}, o),
                            d = 1 === this.nodeType,
                        ...
                        for (r in e) {
                            ...
                            !d || "height" !== t && "width" !== t || (f.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === R.css(this, "display") && "none" === R.css(this, "float") && (R.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                        }
                        null != f.overflow && (this.style.overflow = "hidden");
                        for (r in e) i = new R.fx(this, f, r), n = e[r], vt.test(n) ? (u = R._data(this, "toggle" + r) || ("toggle" === n ? p ? "show" : "hide" : 0)) ? (R._data(this, "toggle" + r, "show" === u ? "hide" : "show"), i[u]()) : i[n]() : (a = yt.exec(n), s = i.cur(), a ? (l = parseFloat(a[2]), "px" !== (c = a[3] || (R.cssNumber[r] ? "" : "px")) && (R.style(this, r, (l || 1) + c), s = (l || 1) / i.cur() * s, R.style(this, r, s + c)), a[1] && (l = ("-=" === a[1] ? -1 : 1) * l + s), i.custom(s, l, c)) : i.custom(s, n, ""));
                        return !0
                    }
                    var o = R.speed(t, n, r);
        ...
        function r(e) {
            ...
            var f = n.join("");
            x.html(f), A.state.originalTgt = x.text(), A.state.smallFont ? x.addClass("input__target__text--small") : x.removeClass("input__target__text--small")
        }
        ...
        function a(e) {
            e && 0 == e.errorCode ? (A.state = u.extend(A.state, e), o(A.state.type), r(e), e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (v.clog("RESULT_DICT_SHOW"), g.render(e.translateResult[0][0].src, e.smartResult)) : g.hide(), d.showVoice(A.state.type)) : x.html(""), L()
        }

        function s(e, t) {
            if (A.state.originalText = e.i, "first" == e.action) return a(global.translatedJson), void t();
        ...
        function l(e, t) {
            "zh-CHS2en" != A.state.type && "en2zh-CHS" != A.state.type || (u(e).hasClass("show-suggest") ? c() : (u(e).addClass("show-suggest"), j.hide(), y.asyRequest({
                ...
                success: function (t) {
                    ...
                    j.find("ul").html(a.join("")), j.css("top", n + i + 10), j.css("left", r), e.addClass("will-update"), j.show()
                }, error: function () {
                    j.hide()
                }
            })))
        ...
        function c() {
            u(".show-suggest").removeClass("show-suggest"), j.hide()
        }
        var u = e("./jquery-1.7"),
            f = e("./utils"),
            d = e("./voice"),
        ...
        ! function () {
            ...
            function r() {
                k && (clearTimeout(k), k = "", u(".fanyi__update__tip").stop(!0, !0)), u(".fanyi__update__tip").hide()
            }
            ...
            x.delegate("span", "mouseover", function () {
                if (!h) {
                    ...
                    }), t(n), u("#transTarget span.hover").removeClass("hover"), n.addClass("hover"), v.clog("MATCHING_HOVER&type=" + A.state.type)
                }
                ...
                var e = A.state.updateEle,
                    ...
                    i = u(this).index();
                A.state.isUpdate = !0, e.text(t), n(), e.addClass("updated");
                ...
                v.clog("RESULT_SINGEL_MODIFY_CLICK"), u("#updateResult").trigger("click", [!0])
            })
        ...
        function s(e) {
            ...
            u[0].scrollTop = 0, f[0] ? (t.addClass("input__small__font"), t.css({
                ...
                r()
            }), y.reset(), b.hideDocTrans()) : (a(), m.showVoice("AUTO"), l("#transTarget").html(""), l("#transTarget").css("height", "auto"), u.css("height", "auto"), g.hide(), l("#docUploadBg").is(":visible") || b.showDocTrans()), i()
        }
        ...
        t.init = function () {
            n("#langSelect").select({
                changedCallback: function () {
                    ...
                    n("#language").val(e), "AUTO" == e ? r.state.isSelectLan = !1 : (r.state.isSelectLan = !0, n("#langSelect").removeClass("empty-lang")), r.state.type = e, "" != n("#inputOriginal").val() && n("#transMachine").trigger("click", [!0, "lan-select"]), i.reset(), o.clog("LAN_SWITCH_CLICK", "")
                }
            })
